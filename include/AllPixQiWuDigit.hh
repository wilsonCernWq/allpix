...
#ifndef AllPixQiWuDigit_h
#define AllPixQiWuDigit_h 1
...
/**
 *  Digit AllPixQiWu class.
 */
class AllPixQiWuDigit : public AllPixDigitInterface {

public:
  AllPixQiWuDigit();
  ~AllPixQiWuDigit();

  AllPixQiWuDigit(const AllPixQiWuDigit&);
  const AllPixQiWuDigit& operator=(const AllPixQiWuDigit&);
  int operator==(const AllPixQiWuDigit&) const;
...
typedef G4TDigiCollection<AllPixQiWuDigit> AllPixQiWuDigitsCollection;

extern G4Allocator<AllPixQiWuDigit> AllPixQiWuDigitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

inline void* AllPixQiWuDigit::operator new(size_t)
{
  void* aDigi;
  aDigi = (void*) AllPixQiWuDigitAllocator.MallocSingle();
  return aDigi;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

inline void AllPixQiWuDigit::operator delete(void* aDigi)
{
  AllPixQiWuDigitAllocator.FreeSingle((AllPixQiWuDigit*) aDigi);
}
